...
var checkIsPieceKing = function () {
    if (currentPlayer === PLAYER.BLUE) {
        BOARD_STATE.slice(0, 8).find(function (piece) {
            if ((piece === null || piece === void 0 ? void 0 : piece.includes("f")) || (piece === null || piece === void 0 ? void 0 : piece.includes("g")) || (piece === null || piece === void 0 ? void 0 : piece.includes("h"))) {
                setPieceToKing(piece);
            }
        });
    }
    else if (currentPlayer === PLAYER.RED) {
        BOARD_STATE.slice(57, 64).find(function (piece) {
            if ((piece === null || piece === void 0 ? void 0 : piece.includes("a")) || (piece === null || piece === void 0 ? void 0 : piece.includes("b")) || (piece === null || piece === void 0 ? void 0 : piece.includes("c"))) {
                setPieceToKing(piece);
            }
        });
    }
};
var setPieceToKing = function (piece) {
    var king = document.querySelector("#" + piece);
    if (king) {
